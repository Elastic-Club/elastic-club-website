      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-24 lg:grid-cols-2">
          <div className="relative flex flex-col justify-center">
            ...
            <h2 className="mb-10 font-akira text-3xl font-black uppercase leading-[1.1] sm:text-4xl md:text-5xl">
            ...
            <div className="space-y-6 md:space-y-8">
              {dict.whyUs.points.map((point: any, i: number) => (
                <div key={i} className="card-base group !p-6 md:!p-8">
                  ...
                  <div className="absolute left-0 top-0 h-2 w-2 bg-primary-500/50" />

                  <div className="flex items-start gap-6 md:gap-8">
                    <div className="font-mono text-2xl font-black text-gray-700 transition-colors group-hover:text-primary-500/20 md:text-3xl">
                      0{i + 1}
                    </div>
                    <div>
          ...
          <div className="group relative">
            ...
            <div className="absolute left-0 top-0 h-4 w-4 border-l border-t border-primary-500" />
            <div className="absolute -bottom-4 -right-4 h-4 w-4 border-b border-r border-primary-500" />
            ...
            <div className="relative h-full min-h-[400px] overflow-hidden bg-black md:min-h-[600px]">
              ...
              <div className="absolute left-8 top-8 md:left-12 md:top-12">
                <div className="mb-2 font-mono text-[8px] uppercase tracking-[0.3em] text-primary-500 md:text-[10px]">
              ...
              <div className="absolute bottom-8 right-8 text-right md:bottom-12 md:right-12">
                <div className="mb-2 font-mono text-[8px] uppercase tracking-[0.3em] text-gray-400 md:text-[10px]">
                  {'// Scale.Capability'}
                </div>
                <div className="text-4xl font-black text-secondary-500 md:text-5xl">10X</div>
              </div>
            </div>
          </div>
        </div>
