    ...
    <div className="px-6 py-32">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-24 text-center">
          ...
          <h1 className="mb-8 mt-8 text-4xl font-black uppercase leading-[0.9] sm:text-5xl md:text-7xl">
            Built to <br />
            ...
            >
              ...
              <div className="p-8 sm:p-10">
                <div className="mb-6 flex items-start justify-between">
                  <h2 className="text-2xl font-black uppercase text-white transition-colors group-hover:text-cyan-400 sm:text-3xl">
                    {item.title}
                  </h2>
                  <span className="rounded-full border border-white/10 px-3 py-1 font-mono text-[10px] font-bold uppercase tracking-widest text-gray-700">
                    Active
                  </span>
                </div>
                <p className="mb-10 text-base leading-relaxed text-gray-500 transition-colors group-hover:text-gray-400 md:text-lg">
                  {item.description}
                </p>
